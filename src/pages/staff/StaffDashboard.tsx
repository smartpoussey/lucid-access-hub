      ...
      <div className="space-y-8">
        <div>
          ...
          <motion.p initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="text-muted-foreground mt-2">
            Manage your assigned client projects.
          </motion.p>
        </div>
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
          <Card className="bg-card border-border">
            <CardHeader>
              <CardTitle className="flex items-center gap-2"><FolderKanban className="h-5 w-5 text-primary" />Assigned Projects</CardTitle>
              <CardDescription>Projects you're currently managing</CardDescription>
            </CardHeader>
            <CardContent>
